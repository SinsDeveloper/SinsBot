...
client = commands.AutoShardedBot(command_prefix = get_prefix,  activity = discord.Activity(type=discord.ActivityType.streaming, name="Getting coded in dpy"), intents = discord.Intents.all())
